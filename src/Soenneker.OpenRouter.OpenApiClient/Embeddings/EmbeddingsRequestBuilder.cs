...
using Soenneker.OpenRouter.OpenApiClient.Embeddings.ModelsRequests;
...
namespace Soenneker.OpenRouter.OpenApiClient.Embeddings
{
    ...
    public partial class EmbeddingsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.OpenRouter.OpenApiClient.Embeddings.ModelsRequests.ModelsRequestBuilder Models
        {
            get => new global::Soenneker.OpenRouter.OpenApiClient.Embeddings.ModelsRequests.ModelsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.OpenRouter.OpenApiClient.Embeddings.EmbeddingsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.OpenRouter.OpenApiClient.Models.CreateEmbeddings200?> PostAsync(global::Soenneker.OpenRouter.OpenApiClient.Models.CreateEmbeddings body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.OpenRouter.OpenApiClient.Models.CreateEmbeddings200> PostAsync(global::Soenneker.OpenRouter.OpenApiClient.Models.CreateEmbeddings body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.OpenRouter.OpenApiClient.Models.CreateEmbeddings200>(requestInfo, global::Soenneker.OpenRouter.OpenApiClient.Models.CreateEmbeddings200.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Submits an embedding request to the embeddings router
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.OpenRouter.OpenApiClient.Models.CreateEmbeddings body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.OpenRouter.OpenApiClient.Models.CreateEmbeddings body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.OpenRouter.OpenApiClient.Embeddings.EmbeddingsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.OpenRouter.OpenApiClient.Embeddings.EmbeddingsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.OpenRouter.OpenApiClient.Embeddings.EmbeddingsRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
