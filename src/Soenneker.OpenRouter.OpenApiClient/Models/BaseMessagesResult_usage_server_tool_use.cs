...
namespace Soenneker.OpenRouter.OpenApiClient.Models
{
    ...
    public partial class BaseMessagesResult_usage_server_tool_use : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        public BaseMessagesResult_usage_server_tool_use()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.OpenRouter.OpenApiClient.Models.BaseMessagesResult_usage_server_tool_use"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.OpenRouter.OpenApiClient.Models.BaseMessagesResult_usage_server_tool_use CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.OpenRouter.OpenApiClient.Models.BaseMessagesResult_usage_server_tool_use();
        }
        /// <summary>
