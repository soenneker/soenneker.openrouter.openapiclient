...
namespace Soenneker.OpenRouter.OpenApiClient.Models
{
    ...
    public partial class ResponsesRequest_provider : IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider_max_price? MaxPrice { get; set; }
#nullable restore
#else
        public global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider_max_price MaxPrice { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider.ResponsesRequest_provider_sort? Sort { get; set; }
#nullable restore
#else
        public global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider.ResponsesRequest_provider_sort Sort { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "max_price", n => { MaxPrice = n.GetObjectValue<global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider_max_price>(global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider_max_price.CreateFromDiscriminatorValue); } },
                ...
                { "sort", n => { Sort = n.GetObjectValue<global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider.ResponsesRequest_provider_sort>(global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider.ResponsesRequest_provider_sort.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider_max_price>("max_price", MaxPrice);
            ...
            writer.WriteObjectValue<global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider.ResponsesRequest_provider_sort>("sort", Sort);
            writer.WriteBoolValue("zdr", Zdr);
        }
        /// <summary>
        /// Composed type wrapper for classes <see cref="global::Soenneker.OpenRouter.OpenApiClient.Models.ProviderSort"/>, <see cref="global::Soenneker.OpenRouter.OpenApiClient.Models.ProviderSortConfig"/>, <see cref="global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider_sortMember1"/>
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ResponsesRequest_provider_sort : IComposedTypeWrapper, IParsable
        {
...
#nullable restore
            ...
            public global::Soenneker.OpenRouter.OpenApiClient.Models.ProviderSortConfig ProviderSortConfig { get; set; }
#endif
            /// <summary>Composed type representation for type <see cref="global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider_sortMember1"/></summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            public global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider_sortMember1? ResponsesRequestProviderSortMember1 { get; set; }
#nullable restore
#else
            public global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider_sortMember1 ResponsesRequestProviderSortMember1 { get; set; }
#endif
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider.ResponsesRequest_provider_sort"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider.ResponsesRequest_provider_sort CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var result = new global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider.ResponsesRequest_provider_sort();
                if(parseNode.GetEnumValue<global::Soenneker.OpenRouter.OpenApiClient.Models.ProviderSort>() is global::Soenneker.OpenRouter.OpenApiClient.Models.ProviderSort providerSortValue)
                {
                    ...
                    result.ResponsesRequestProviderSortMember1 = new global::Soenneker.OpenRouter.OpenApiClient.Models.ResponsesRequest_provider_sortMember1();
                }
                return result;
            }
            /// <summary>
            ...
            public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
            {
                if(ProviderSortConfig != null || ResponsesRequestProviderSortMember1 != null)
                {
                    return ParseNodeHelper.MergeDeserializersForIntersectionWrapper(ProviderSortConfig, ResponsesRequestProviderSortMember1);
                }
                return new Dictionary<string, Action<IParseNode>>();
            }
            /// <summary>
            ...
            public virtual void Serialize(ISerializationWriter writer)
            {
                ...
                if(ProviderSort != null)
                {
                    ...
                    writer.WriteObjectValue<global::Soenneker.OpenRouter.OpenApiClient.Models.ProviderSortConfig>(null, ProviderSortConfig, ResponsesRequestProviderSortMember1);
                }
            }
        }
    }
