...
namespace Soenneker.OpenRouter.OpenApiClient.Guardrails.Item.Assignments.Members
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public static global::Soenneker.OpenRouter.OpenApiClient.Guardrails.Item.Assignments.Members.MembersPostResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.OpenRouter.OpenApiClient.Guardrails.Item.Assignments.Members.MembersPostResponse();
        }
        /// <summary>
